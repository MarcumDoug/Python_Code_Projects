# File: chuck_norris_jokes.py
# Name: Doug Marcum
# Date: 10/28/2019
# Course: DSC 510
# Assignment Number: 10.1
# Description: Program uses request library to get the Chuck Norris Jokes API, parses the JSON data,
#              allows the user to receive as many jokes as they would like or exit the program.
